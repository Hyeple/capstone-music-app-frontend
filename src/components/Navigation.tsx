	...
	return (
		<>
			<motion.nav
				...
				initial="close"
				className="bg-neutral-900 flex flex-col z-10 gap-20 p-5 absolute top-0 left-0 h-full shadow shadow-neutral-600 z-30"
			>
			...
			<AnimatePresence>
				{(isOpen || selectedProject) && (
					<motion.div
						...
						animate="visible"
						exit="hidden"
						className="fixed inset-0 bg-white bg-opacity-30 z-10"
