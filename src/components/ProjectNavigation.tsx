...
const ProjectNavigation = ({
	...
	return (
		<motion.nav
			...
			className={`h-full flex flex-col gap-8 w-64 absolute bg-neutral-800 ml-0 ${
		...
		>
			...
			<div className="flex flex-col gap-3">
				<NavigationLink name="악보 보기">
					<MusicalNoteIcon className="stroke-[0.75] stroke-inherit min-w-8 w-8" />
				</NavigationLink>
				<NavigationLink name="연습 시간">
					<ClockIcon className="stroke-[0.75] stroke-inherit min-w-8 w-8" />
				</NavigationLink>
				<NavigationLink name="메모">
